...
export interface DogboneMetadata {
  primaryColor: string;
  accentColor: string;
  rarity: string;
...
export const decodeDogboneMetadata = (decoded: Decoded): DogboneMetadata => ({
    primaryColor: decoded["primary_color"] as string,
    accentColor: decoded["accent_color"] as string,
...
export const DogboneMetadataSchema: Schema =  {
    struct: {

...
async function main(feePayer: Keypair) {
    ...
    /**
     * Derive the Dogbone Metadata so we can retrieve it later
     */
    const [gemPub] = deriveDogboneMetadataPDA(
        {
            mint: mint.publicKey,
        },
        progId,
    );
    console.info("+==== Dogbone Metadata Address ====+");
    ...
    await mintSendAndConfirm({
        ...
        accentColor: "Brown",
        rarity: "Rare",
        shortDescription: "Who let the dogs out?!",
        signers: {
            feePayer: feePayer,
            funding: feePayer,
            mint: mint,
    ...
    /**
     * Get the Dogbone Metadata
     */
    let gem = await getDogboneMetadata(gemPub);
    console.info("+==== Dogbone Metadata ====+");
    console.info(gem);
     ...
     * Get the Dogbone Metadata
     */
    gem = await getDogboneMetadata(gemPub);
    console.info("+==== Dogbone Metadata ====+");
    console.info(gem);

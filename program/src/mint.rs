...
use crate::generated::state::{Account, AccountPDA, DogboneMetadata};
...
pub fn mint(
    ...
    dogbone: &mut AccountPDA<DogboneMetadata>,
    funding: &AccountInfo,
    ...
    dogbone.data.primary_color = primary_color;
    dogbone.data.accent_color = accent_color;
    dogbone.data.rarity = rarity;
    dogbone.data.short_description = short_description;
    dogbone.data.mint = *mint.info.key;
    dogbone.data.assoc_account = Some(*assoc_token_account.key);
